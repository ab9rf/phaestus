...
use_declaration:
        ...
        |        '\\' namespace_name                         { UseG $2 }
        |        '\\' namespace_name T_AS IDENT         { UseGAs $2 $4 }
;
...
combined_scalar_offset:
    ...
    | T_STRING_CONST '[' dim_offset ']'         { CombinedScalarWithOffset $1 [$3] }
...
static_scalar: 
        ...
        |        T_NAMESPACE '\\' namespace_name { NamespaceSelf $3 }
        |        '\\' namespace_name         { NamespaceAbsolute $2 }
...
non_empty_static_array_pair_list:
                non_empty_static_array_pair_list ',' static_scalar '=>' static_scalar        { (ArrayPairKV $3 $5):$1 }        
        |        non_empty_static_array_pair_list ',' static_scalar                                 { (ArrayPairV $1):$3 }
        |        static_scalar '=>' static_scalar                                         { [ArrayPairKV $1 $3] }
